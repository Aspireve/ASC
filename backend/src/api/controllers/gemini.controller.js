...
exports.geminiPrompts = async (req, res, next) => {
  try {
    ...
    const prompt = `
 You are a senior legal counsel with extensive experience in ${industry_type} organizations. Review the following ${title} agreement and provide 2-3 high-priority recommendations, considering:

1. Legal and compliance requirements specific to ${industry_type} sector
