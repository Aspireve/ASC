...
import ProposedAccepted from "./proposed-accepted";
import ProposedIssues from "./proposed-issues";
import ProposedPending from "./proposed-pending";
