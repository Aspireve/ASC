      ...
      <main className="relative min-h-screen bg-transparent">
        ...
        <div id="hero" className="container mx-auto px-4">
          <div className="relative min-h-screen flex flex-col items-center justify-center">
            ...
            <FloatingIcon
              color="purple-500"
              position="-top-4 -left-4 md:top-[10rem] md:left-20"
            >
              <div className="p-4 bg-[#fff] shadow-lg rounded-lg">
                <Copy className="w-10 h-10" />
              </div>
            </FloatingIcon>
            <FloatingIcon
              color="orange-500"
              position="-top-4 -right-4 md:top-20 md:right-20"
            >
              <Shield className="w-6 h-6" />
            </FloatingIcon>
            <FloatingIcon
              color="green-500"
              position="-bottom-4 -left-4 md:bottom-20 md:left-20"
            >
              <Copy className="w-6 h-6 rotate-90" />
            </FloatingIcon>
            <FloatingIcon
              color="blue-500"
              position="-bottom-4 -right-4 md:bottom-20 md:right-20"
            >
